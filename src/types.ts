...
export interface AttachmentMetadata {name: string; mime?: string; id?: string}
export interface UploadFile extends AttachmentMetadata {data: AttachmentData}
...
export interface NotificationInput extends MessageContent {files?: UploadFile[]; image?: UploadFile; icon?: UploadFile}
export type SendOptions = MessageOptions & RequestOptions;
export interface Envelope {enc: string; ciphertext: string}
